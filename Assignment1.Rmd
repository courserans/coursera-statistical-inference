---
title: 'Statistical Inference : Project : Exponential Distribution Properties'
author: "courserans"
...
```
* Theoretical mean of the exponential distribution with n=40, lambda = 0.2 is : `r Theoretical.mean`
* Sample mean from 1000 simulation of exponential distribution(n=40, lambda=0.2) is : `r Observed.mean`

```{r,fig.align='center', fig.path='fig/'}
library(ggplot2)
...
```
* Theoretical Variance of the exponential distribution with n=40, lambda = 0.2 is : `r Theoretical.variance`
* Sample variance from 1000 simulation of exponential distribution(n=40, lambda=0.2) is : `r Observed.variance`
...
```
Fig 2: The left panel shows a histogram of the sample means for 1000 different random samples. The red curve indicates a normal density function (mu - 5, variance - 0.625). The blue vertical line is the observed sample mean of `r Observed.mean`. The right panel shows a normal probability plot of those sample means.
